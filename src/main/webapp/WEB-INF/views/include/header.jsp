...
<link rel="stylesheet"
	href="/shop/resources/vendors/bootstrap/bootstrap.min.css">
<link rel="stylesheet"
	href="/shop/resources/vendors/fontawesome/css/all.min.css">
<link rel="stylesheet"
	href="/shop/resources/vendors/themify-icons/themify-icons.css">
<link rel="stylesheet"
	href="/shop/resources/vendors/nice-select/nice-select.css">
<link rel="stylesheet"
					...
					<div class="collapse navbar-collapse offset"
						...
						<ul class="nav navbar-nav menu_nav ml-auto mr-auto">
							...
							<li class="nav-item active submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link"
										href="single-product">Product Details</a></li>
							...
							<li class="nav-item submenu dropdown"><a href="#"
								class="nav-link dropdown-toggle" data-toggle="dropdown"
								role="button" aria-haspopup="true" aria-expanded="false">QnA</a>
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link"
										href="/shop/qa-list">QnA</a></li>
								</ul></li>
						</ul>
							...
							<c:choose>
								<c:when test="${ empty loginuser }">
									<li class="nav-item"><a class="button button-header"
										href="/shop/account/login">Login</a> <a
										class="button button-header" href="/shop/account/register">Register</a>
									</li>
								</c:when>
								<c:otherwise>
									<li class="nav-item"><a class="nav-link"
										href="/shop/mypage/${ loginuser.memberId }"
										style="text-decoration: none">${ loginuser.memberId }님
											환영합니다.</a> <a class="button button-header"
