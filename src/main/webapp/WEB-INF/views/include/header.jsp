               ...
               <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                  <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                     ...
                     <c:if test="${ loginuser.memberId eq 'manager' }">
                     	<li class="nav-item ${ nav eq 'manager' ? 'active':''}"><a class="nav-link" href="/shop/manager/list-product">Manager</a></li>
                     </c:if>
                  </ul>
                  <ul class="nav-shop ml-auto">
                     ...
                     <c:otherwise>
						<li class="nav-item">
							<a class="nav-link" href="/shop/account/mypage" style="text-decoration: none">${ loginuser.name }님 환영합니다.</a>
						</li>
